"""Base class for YAML manipulation steps."""
import re
from abc import ABC
...
class BaseYAMLStep(StepBase, MemoryMixin, ABC):
    """Base class for YAML steps with shared functionality.

    Inherits from MemoryMixin for centralized template resolution.
    """

    category = "yaml"
    can_be_tool = True  # All YAML steps can be wrapped as LLM tools
